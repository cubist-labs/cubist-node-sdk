...
import { NamedContract as NamedSolidityContract, Contract as SolidityContract, Address as SolidityAddress } from './solidity';
 ...
 */
export declare abstract class TargetProjectHandler {
     ...
     * */
    abstract getNamedContract(name: ContractName, addr?: ContractAddress, ignoreReceipt?: boolean): NamedContract;
