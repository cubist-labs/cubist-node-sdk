 ...
 * @group Testing
 * */
export type CubistClassRef<T extends Cubist> = {
    new (config?: Config): T;
};
/**
 ...
 * @group Testing
 * */
export declare class TestDK<T extends Cubist> {
    ...
    * Configs too). */
    private readonly _cubist;
    private readonly _config;
    private services;
    private custom_build_dir?;
    private custom_deploy_dir?;
     ...
     * @param {Services?} service - Service to stop.
     */
    stopServiceOnExit(service?: Service): void;
}
/**
 ...
 * @group Testing
 */
export declare class CubistTestDK extends TestDK<Cubist> {
 ...
 * functionality.
 */
declare class TestCubistConfig extends Cubist {
...
export declare class ConfigTestDK extends TestDK<TestCubistConfig> {
